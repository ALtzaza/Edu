// src/pages/HomePage/HomePage.jsx (ฉบับ V18 - สมบูรณ์)
            ...
            <div className="course-image-container">
              <div 
                ...
                style={{ 
                  ...
                  backgroundColor: course.thumbnail ? '#1E1E1E' : (index % 2 === 0 ? '#007ACC' : '#569CD6')
                }}
              >
            ...
            <div className="course-content-container">
              ...
              <p>
                {course.description ? 
                  ...
                  (index % 2 === 0 ? '"หลักสูตรที่เข้าใจง่าย..."' : '"ชุมชนที่พร้อมสนับสนุน..."')
                }
              </p>
...
const TypingAnimation = () => {
  ...
  return (
    <div className="typing-box-js">
      <span className="token-const">const</span> <span className="token-function">typeLoop</span> <span className="token-punctuation">=</span> <span className="token-punctuation">()</span> <span className="token-punctuation">=</span> <span className="token-punctuation">{'{'}</span>
      <br />
      <span style={{ paddingLeft: '1rem' }} className="token-comment">/* {typedText} */</span>
    ...
    <div className="homepage-container">
        ...
        <div className="hero-codepen-mock">
          ...
          <div className="code-box">
            ...
            <div className="code-content">
              ...
              <pre> 
                <span className="token-tag">{'<div'}</span> <span className="token-attr">{'class='}</span><span className="token-string">{'"Tid_Code"'}</span><span className="token-tag">{'>'}</span>
                <br />
          ...
          <div className="code-box">
            ...
            <div className="code-content">
              <pre>
                <span className="token-selector">{'.rect'}</span> <span className="token-punctuation">{'{'}</span>
                <br/>
                {'  '}<span className="token-keyword">{'background'}</span>: <span className="token-function">{'linear-gradient'}</span>(...);
                <br/>
                {'  '}<span className="token-const">{'$gray'}</span>: <span className="token-string">{'#74B088'}</span>;
                <br/>
                <span className="token-punctuation">{'}'}</span>
              </pre>
            </div>
      ...
      <section className="about-section">
        ...
        <div className="about-content">
          <h2>Who we are</h2>
          <p>
            "ที่ "Tid-Code", เราหลงใหลในการสร้างชุมชน..."
          </p>
      ...
      <section className="cta-section">
        <h2>
          Code is Future.<br />You are the Builder.
        </h2>
        <Link to="/courses" className="cta-button" style={{ backgroundColor: 'white', color: '#10162F' }}>
          Explore All Courses
        </Link>
      </section>
